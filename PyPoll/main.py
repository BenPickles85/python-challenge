...
csvpath = r"C:\Users\Guest1\Documents\Bootcamp\Homework1\python-challenge\PyPoll\Resources\election_data.csv"
...
#Create lists from dictionary for camndidates and their vote count
candidate_list = []
candidate_votes = []
